...
<html>
    ...
    <body>
        ...
        <div id="show-actor" class="content scaffold-show" role="main">
            ...
            <f:display bean="actor" />
            <g:form resource="${this.actor}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.actor}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
