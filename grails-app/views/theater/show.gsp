...
<html>
    ...
    <body>
        ...
        <div id="show-theater" class="content scaffold-show" role="main">
            ...
            <f:display bean="theater" />
            <g:form resource="${this.theater}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.theater}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
